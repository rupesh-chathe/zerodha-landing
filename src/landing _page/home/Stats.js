      ...
      <div className='container p-3' >
        <div className='row p-5'>
          <div className='col-6 p-5'>
            <h1 className='fs-2'> Trust the confidance</h1>
...
way you like.</p><h2 className='fs-4'>The Zerodha universe</h2>
...
your needs.</p><h2 className='fs-4'>Do better with money</h2>
